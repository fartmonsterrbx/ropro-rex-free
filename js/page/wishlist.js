...
if (myUser.toString() == userid) {
	tradeButton = `<button style="position:absolute;left:950px;top:27px;height:50px;transform:scale(1.2);" class="removebutton reseller-purchase-button btn-min-width btn-buy-md ng-binding" onclick="">Remove</button>`
} else {
	tradeButton = `<button style="position:absolute;left:950px;top:27px;height:50px;transform:scale(1.2);" class="trade-with-user reseller-purchase-button btn-min-width btn-buy-md ng-binding" tradesurl="https://www.roblox.com/users/${parseInt(userid)}/trade" onclick="if (this.getAttribute('trades-enabled') == null || this.getAttribute('trades-enabled') == 'true') { window.open('https://www.roblox.com/users/${parseInt(userid)}/trade', '_blank'); }">Trade</button>`
}
offerHTML = `
...
<div>
   ...
   <div style="position:absolute;left:285px;bottom:10px;font-size:12px;" class="itemrap"><div style="display:inline-block;font-size:12px;margin-right:0px;"></div><div style="height:20px;margin-top:-5px;display: inline-block;">
   <span style="margin-left:-5px;margin-right:-8px;margin-bottom:0px;transform: scale(0.4);" id="nav-robux" class="icon-robux-28x28 roblox-popover-close"></span>
   <span style="font-size:12px;" class="rbx-text-navbar-right text-header total-value">---</span></div></div>
   <div style="position:absolute;left:285px;bottom:-8px;font-size:12px;" class="itemvalue"><div style="margin-top:-5px;display: inline-block;">
   <img style="width:10px;margin-left:4px;" src="${chrome.runtime.getURL('/images/ropro_icon_small.png')}">
   <span style="font-size:12px;" class="rbx-text-navbar-right text-header total-value">---</span></div></div>
   <div style="position:absolute;left:685px;bottom:10px;font-size:12px;display:none;" class="wantitemrap"><div style="display:inline-block;font-size:12px;margin-right:0px;"></div><div style="height:20px;margin-top:-5px;display: inline-block;">
	<span style="margin-left:-5px;margin-right:-8px;margin-bottom:0px;transform: scale(0.4);" id="nav-robux" class="icon-robux-28x28 roblox-popover-close"></span>
	<span style="font-size:12px;" class="rbx-text-navbar-right text-header total-value">---</span></div></div>
	<div style="position:absolute;left:685px;bottom:-8px;font-size:12px;display:none;" class="wantitemvalue"><div style="margin-top:-5px;display: inline-block;">
	<img style="width:10px;margin-left:4px;" src="${chrome.runtime.getURL('/images/ropro_icon_small.png')}">
	<span style="font-size:12px;" class="rbx-text-navbar-right text-header total-value">---</span></div></div>
